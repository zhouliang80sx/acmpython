...
<title>libs/polygon/example/voronoi_basic_tutorial.cpp - 1.54.0</title>  <link rel="icon" href="/favicon.ico" type="image/ico" />
...
<body>
  ...
  <div class="boost-common-header-notice"><a class="boost-common-header-inner" href="/doc/libs/release/libs/polygon/example/voronoi_basic_tutorial.cpp">This is the documentation for an old version of Boost.
        ...
        <div class="section" id="docs">
          <div class="section-0">
            <div class="section-body">
              <h3>libs/polygon/example/voronoi_basic_tutorial.cpp</h3>
<pre>
